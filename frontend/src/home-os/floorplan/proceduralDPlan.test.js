import { D_PLAN_FOUNDATIONS, D_PLAN_FURNITURE, D_PLAN_ROOMS, D_PLAN_WALLS, resolveDPlanConfig } from './proceduralDPlan';
...
test('D plan exposes the supplied three-bedroom layout and safe defaults', () => {
  ...
  expect(D_PLAN_FOUNDATIONS).toHaveLength(3);
  expect(D_PLAN_FURNITURE.filter((item) => item.kind === 'bed')).toHaveLength(3);
